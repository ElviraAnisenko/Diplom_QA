...
_Ожидаемый результат_: Запрос отправлен, появляется всплывающее окно "Успешно операция одобрена банком", поляполей не подсвечиваются красным цветом, подписи ошибок под полями пропадают.
